...
//The nested function is still contained inside of the parent function so it can use any information inside of the original function scope.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    const lowerCaseNames = zooAnimals.map((animals) => {
  ...
  */
  ...
  function USApop(callback){
    let totalPopulation = callback.reduce((sum,item)=>{
...
function greeting(first,last){
  // const cb = function(first,last){
    return `Hello ${first} ${last}, nice to meet you!`
  // }
  // return consume(first, last, cb)
}
